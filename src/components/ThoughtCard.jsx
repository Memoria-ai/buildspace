...
const ThoughtCard = ({onActivity, note, session}) => {
  ...
  return (
    <div className={styles["card-container"]}>
        ...
        <textarea value={content} onChange={handleContentChange} placeholder='Your thought here...' className={styles.transcript}/>
        ...
        <div className={styles.thoughtActionMenu}>
            ...
            <div className={styles.roundedGradientBorder}>
                <button onClick={handleUpdateClick} className={styles.thoughtActionButton2}>Update</button>
            </div>
        </div>
    </div>
  )
